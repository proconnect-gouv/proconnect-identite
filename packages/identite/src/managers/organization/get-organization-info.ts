...
import type { ApiEntrepriseInseeClient } from "@proconnect-gouv/proconnect.api_entreprise/api";
import {
...
export function getOrganizationInfoFactory(config: ApiEntrepriseInseeClient) {
