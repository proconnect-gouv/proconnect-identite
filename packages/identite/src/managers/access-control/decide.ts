...
export function decide_access(
  ...
  if (stop_after === "session_auth") return { type: "pass" };
  ...
  if (stop_after === "email_verified") return { type: "pass" };
