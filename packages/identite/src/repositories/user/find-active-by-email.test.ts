...
import { findActiveByEmailFactory } from "./find-active-by-email.js";

//

const findActiveByEmail = findActiveByEmailFactory({ pg: pg as any });

suite("findActiveByEmailFactory", () => {
  before(migrate);
  ...
  test("should find a user by email", async () => {
    ...
    const user = await findActiveByEmail("lion.eljonson@darkangels.world");
