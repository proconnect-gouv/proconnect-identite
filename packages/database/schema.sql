...
ALTER TABLE IF EXISTS ONLY "public"."users_organizations" DROP CONSTRAINT IF EXISTS "users_organizations_user_id_fkey";
ALTER TABLE IF EXISTS ONLY "public"."users_organizations" DROP CONSTRAINT IF EXISTS "users_organizations_organization_id_fkey";
ALTER TABLE IF EXISTS ONLY "public"."users_oidc_clients" DROP CONSTRAINT IF EXISTS "users_oidc_clients_user_id_fkey";
ALTER TABLE IF EXISTS ONLY "public"."users_oidc_clients" DROP CONSTRAINT IF EXISTS "users_oidc_clients_organization_id_fkey";
ALTER TABLE IF EXISTS ONLY "public"."users_oidc_clients" DROP CONSTRAINT IF EXISTS "users_oidc_clients_oidc_client_id_fkey";
ALTER TABLE IF EXISTS ONLY "public"."moderations" DROP CONSTRAINT IF EXISTS "moderations_user_id_fkey";
ALTER TABLE IF EXISTS ONLY "public"."moderations" DROP CONSTRAINT IF EXISTS "moderations_organization_id_fkey";
ALTER TABLE IF EXISTS ONLY "public"."franceconnect_userinfo" DROP CONSTRAINT IF EXISTS "franceconnect_userinfo_user_id_fkey";
ALTER TABLE IF EXISTS ONLY "public"."email_domains" DROP CONSTRAINT IF EXISTS "email_domains_organization_id_fkey";
ALTER TABLE IF EXISTS ONLY "public"."authenticators" DROP CONSTRAINT IF EXISTS "authenticators_user_id_fkey";
...
ALTER TABLE IF EXISTS ONLY "public"."users_organizations" DROP CONSTRAINT IF EXISTS "users_organizations_pkey";
ALTER TABLE IF EXISTS ONLY "public"."users_oidc_clients" DROP CONSTRAINT IF EXISTS "users_oidc_clients_pkey";
ALTER TABLE IF EXISTS ONLY "public"."email_domains" DROP CONSTRAINT IF EXISTS "unique_organization_domain";
ALTER TABLE IF EXISTS ONLY "public"."organizations" DROP CONSTRAINT IF EXISTS "organizations_pkey";
ALTER TABLE IF EXISTS ONLY "public"."oidc_clients" DROP CONSTRAINT IF EXISTS "oidc_clients_pkey";
ALTER TABLE IF EXISTS ONLY "public"."moderations" DROP CONSTRAINT IF EXISTS "moderations_pkey";
ALTER TABLE IF EXISTS ONLY "public"."franceconnect_userinfo" DROP CONSTRAINT IF EXISTS "franceconnect_userinfo_pkey";
ALTER TABLE IF EXISTS ONLY "public"."email_domains" DROP CONSTRAINT IF EXISTS "email_domains_pkey";
ALTER TABLE IF EXISTS ONLY "public"."authenticators" DROP CONSTRAINT IF EXISTS "authenticators_pkey";
ALTER TABLE IF EXISTS "public"."users_oidc_clients" ALTER COLUMN "id" DROP DEFAULT;
ALTER TABLE IF EXISTS "public"."users" ALTER COLUMN "id" DROP DEFAULT;
ALTER TABLE IF EXISTS "public"."organizations" ALTER COLUMN "id" DROP DEFAULT;
ALTER TABLE IF EXISTS "public"."oidc_clients" ALTER COLUMN "id" DROP DEFAULT;
ALTER TABLE IF EXISTS "public"."moderations" ALTER COLUMN "id" DROP DEFAULT;
ALTER TABLE IF EXISTS "public"."email_domains" ALTER COLUMN "id" DROP DEFAULT;
...
CREATE SEQUENCE "public"."users_oidc_clients_id_seq"
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE ONLY "public"."moderations" ALTER COLUMN "id" SET DEFAULT "nextval"('"public"."moderations_id_seq"'::"regclass");
...
ALTER TABLE ONLY "public"."users_oidc_clients" ALTER COLUMN "id" SET DEFAULT "nextval"('"public"."users_oidc_clients_id_seq"'::"regclass");
